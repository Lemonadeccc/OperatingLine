  ...
  try {
    ...
    if (
      ...
      goalWork = goalWork.then(async () => {
        ...
        assert.equal(goalRequest.catalogVersion, '1.9.0');
...
try {
  ...
  assert.equal(revisionRequests[0].catalogVersion, '1.9.0');
  ...
  assert.equal(evalBundle.catalogs[0].catalogVersion, '1.9.0');
